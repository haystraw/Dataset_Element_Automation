...
public class UpdateDatasets {
        ...
        String testMap = "testing";

        Map<String, String> rightHereMap = new HashMap<String, String>() {
                {
                        put("search_name", "All Resources");
                        put("save_filename", "resources.json");
                        put("save_filename", "resources.json");
                }
        };

        /*
         * private static final String defaultPod = "dmp-us";
         * private static final String defaultUser = "shayes_compass";
         * private static final String defaultPwd = "Infa2024!";
         */
        private static final String extractsFolder = "./data";
        private static final String defaultConfigFile = "./config.csv";
